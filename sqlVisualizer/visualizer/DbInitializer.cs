...
public class DbInitializer(IConfiguration config)
{
    public void Initialize()
    {
        ...
        tableCmd.CommandText =
            ...
            CREATE or replace SEQUENCE wind_turbine_production_id_seq START 1;

            -- Create table
            CREATE or replace TABLE wind_turbine_production (
                id              INTEGER         PRIMARY KEY DEFAULT nextval('wind_turbine_production_id_seq'),
            ...
            -- Insert data
            INSERT INTO wind_turbine_production (production_date, turbine_id, power_output)
            VALUES
